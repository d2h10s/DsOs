...
#define FIQ_STACK_SIZE      (ABS_STACK_START - FIQ_STACK_START)
#define ABS_STACK_SIZE      (UND_STACK_START - ABT_STACK_START)
...
#define ABT_STACK_TOP       (FIQ_STACK_START + ABT_STACK_SIZE - 4)
